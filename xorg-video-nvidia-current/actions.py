...
# modify by atolboo    pisitools.dosym("../nvidia-current/vdpau/libvdpau_nvidia.so.%s" % version, "/usr/lib/vdpau/libvdpau_nvidia.so.1")
...
# modify by atolboo     pisitools.insinto(datadir, "ld.so.conf")
 # modify by atolboo    pisitools.insinto(datadir, "XvMCConfig")
